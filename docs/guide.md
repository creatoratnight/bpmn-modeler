...
![BPMN Modeler sign-in screen with Google and Microsoft options](assets/screenshots/sign-in.png)
...
![The "Your Projects" list](assets/screenshots/projects-list.png)
...
![The Add Project dialog](assets/screenshots/add-project-modal.png)
...
![A project showing a folder and a model, with the toolbar to add models and folders](assets/screenshots/project-view.png)
...
![The Add model dialog](assets/screenshots/add-model-modal.png)
...
![The BPMN editor with a simple diagram](assets/screenshots/bpmn-editor.png)
...
![The Milestones (version history) dialog](assets/screenshots/milestones-modal.png)
...
![The comments panel open in the editor](assets/screenshots/comments-panel.png)
...
![The Invite Member dialog](assets/screenshots/invite-modal.png)
...
### Screenshots
- The images in `docs/assets/screenshots/` are generated by the `capture-screenshots` skill from `e2e/screenshots/manifest.ts` (`npm run screenshots`). Regenerate them when the UI changes rather than editing the PNGs by hand.
